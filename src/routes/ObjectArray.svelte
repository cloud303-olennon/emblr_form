...
<div class="flex-column">
  {#each count as c}
    <div class="border-b-2 border-primary-900">
        ...
        <div class="mb-3">
          {#if type === "checkbox"}
            <div class="form-check form-switch">
              <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name={field + c}>
